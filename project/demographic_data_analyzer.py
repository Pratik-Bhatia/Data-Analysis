...
Original file is located at
    https://colab.research.google.com/drive/1vHqz65F99VoDUF1RNjzC0lrV2nco_-Cc
"""
...
def calculate_demographic_data(print_data=True):
    ...
    lower_education_rich = (lower_education[lower_education["salary"] == '>50K'].shape[0] / lower_education.shape[0]) * 100
     ...
     # Calculate the minimum work hours
    min_work_hours = df["hours-per-week"].min()

    # Calculate the percentage of rich among those who work the fewest hours
    ...
    # Identify the top occupation in India for those earning >50K
